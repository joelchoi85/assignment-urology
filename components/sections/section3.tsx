...
const visions: ImageCardProps[] = [
  {
    ...
    details: {
      slogans: [
        <div key="slogan-0" className="font-bold">서울병원 전문의 출신</div>,
        <div key="slogan-1" className="font-bold">성균관대학교 의과대학 외래부교수</div>,
      ],
      descriptions: [
        <div key="desc-0">
  ...
  },
  {
    ...
    details: {
      slogans: [
        <div key="slogan-0" className="font-bold">담당 의료진이 상담부터 시술 및 수술</div>,
        <div key="slogan-1" className="font-bold">수술 후 관리까지 체계적 관리</div>,
      ],
      descriptions: [
        <div key="desc-0">환자 한 분 한 분 개인 상태에 따라</div>,
        <div key="desc-1">
  ...
  },
  {
    ...
    details: {
      slogans: [
        <div key="slogan-0" className="font-bold">요로결석 응급센터 365일 24시간</div>,
        <div key="slogan-1">시간 상관없이 요로결석 치료 가능</div>,
      ],
      descriptions: [
        <div key="desc-0">
          <span className="font-bold">당일검사와 당일치료,</span>
        </div>,
        <div key="desc-1">그리고 수술까지 한 번에 해결</div>,
      ],
    },
  },
  {
    ...
    details: {
      slogans: [
        <div key="slogan-0" className="font-bold">끊임없는 연구, 해외교류 학술활동</div>,
        <div key="slogan-1">독보적인 치료 시스템 보유</div>,
      ],
      descriptions: [
        <div key="desc-0">비뇨기질환 정복을 위해</div>,
        <div key="desc-1">
